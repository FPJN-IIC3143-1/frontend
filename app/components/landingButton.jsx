export default function LandingButton({ bgColor, textColor, boxWidth, text, onClick }) {
  return (
    <button 
      ...
      onClick={(e) => {
        console.log("LandingButton clicked"); // Este log debería aparecer
        if (onClick) {
          onClick(e); // Llama a la función onClick que se pasa como prop
        }
      }}
      onMouseEnter={(e) => {
        e.target.style.backgroundColor = "#D0BCFE";
